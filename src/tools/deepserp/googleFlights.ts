...
export const googleFlights = defineTool({
  ...
  inputSchema: {
    ...
    multi_city_json: z
      ...
      .optional(),
    adults: z.number().describe('Parameter defines the number of adults. Default to 1.').default(1),
    children: z.number().describe('Parameter defines the number of children. Default to 0.').default(0),
    infants_in_seat: z.number().describe('Parameter defines the number of infants in seat. Default to 0.').default(0),
    infants_on_lap: z.number().describe('Parameter defines the number of infants on lap. Default to 0.').default(0),
    outbound_date: z
      .string()
    ...
    include_airlines: z
      ...
      .optional()
      .optional(),
    bags: z.number().describe('Parameter defines the number of carry-on bags. Default to 0.').default(0),
    max_price: z.number().describe('Parameter defines the maximum ticket price. Default to unlimited.').default(0),
    outbound_times: z
      .string()
    ...
    return_times: z
      ...
      .optional(),
    emissions: z
      .union([z.literal(0).describe('reset'), z.literal(1).describe('Less emissions only - ·')])
